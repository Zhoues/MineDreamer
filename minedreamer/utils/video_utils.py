...
def load_frame_from_video(filepath, frame_id, to_rgb=True):
    cap = cv2.VideoCapture(filepath)
    ...
    if ret:
        ...
        raise ValueError(f"Failed to grab frame {frame_id} from {filepath}, please check carefully")
