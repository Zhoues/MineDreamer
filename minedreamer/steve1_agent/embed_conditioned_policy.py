...
from minedreamer.VPT.lib.action_head import make_action_head
from minedreamer.VPT.lib.action_mapping import CameraHierarchicalMapping
from minedreamer.VPT.lib.impala_cnn import ImpalaCNN
from minedreamer.VPT.lib.normalize_ewma import NormalizeEwma
from minedreamer.VPT.lib.scaled_mse_head import ScaledMSEHead
from minedreamer.VPT.lib.tree_util import tree_map
from minedreamer.VPT.lib.util import FanInInitReLULayer, ResidualRecurrentBlocks
from minedreamer.VPT.lib.misc import transpose
...
class MinecraftPolicy(nn.Module):
    ...
    def __init__(
        ...
        mineclip_embed_dim=512,  # NOTE MODIFIED (added this)
        **unused_kwargs,
    ):
        super().__init__()
