...
def play_interactive(args, cvae_manager, metadata):
    ...
    prompt_id = 0
    prompt_list = ["collect dirt", "build a tower"]
...
def main(args):
    ...
    for i in range(1, args.times + 1):
        args.save_video_dir = os.path.join(save_video_dir, f"dirt_tower_{i}")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_video_dir', type=str, default='data/play/chaining/dirt_tower')
