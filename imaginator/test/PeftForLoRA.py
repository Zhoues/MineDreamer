...
class PeftModel_for_LLM(PushToHubMixin, torch.nn.Module):
    """
...
class PeftModelForCausalLM(PeftModel_for_LLM):
    """
    ...
    def forward(
        ...
        **kwargs,
        ...
        if not isinstance(peft_config, PromptLearningConfig):
            ...
            # type(self.base_model) -> <class 'peft.tuners.lora.LoraModel'>
            return self.base_model(
                input_ids=input_ids,
                attention_mask=attention_mask,
