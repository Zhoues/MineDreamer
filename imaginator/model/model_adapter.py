...
from imaginator.conversation_v01 import Conversation, get_conv_template
from imaginator.model.compression import load_compress_model
from imaginator.model.monkey_patch_non_inplace import (
    replace_llama_attn_with_non_inplace_operations,
)
from imaginator.utils import get_gpu_memory
...
class RwkvAdapter(BaseAdapter):
    ...
    def load_model(self, model_path: str, from_pretrained_kwargs: dict):
        from imaginator.model.rwkv_model import RwkvModel
