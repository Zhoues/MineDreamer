...
from peft.utils import PromptLearningConfig, _prepare_prompt_learning_config
...
def get_peft_model(model: PreTrainedModel, peft_config: PeftConfig, adapter_name: str = "default") -> PeftModel:
    ...
    # peft_config.task_type='CAUSAL_LM' -> PeftModelForCausalLM, type(model)=<class 'imaginator.model.UNETLLMLoRA_model.LLMSD_V03'>
